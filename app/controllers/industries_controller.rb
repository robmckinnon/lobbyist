class IndustriesController < ApplicationController
  ...
  def show
    ...
    @section, @organisations, @lobbyists, @people = CompanyClassification.find_section_and_organisations_and_lobbyists_and_people code
  ...
  def show_class
    ...
    @section, @organisations, @lobbyists, @people = CompanyClassification.find_section_and_organisations_and_lobbyists_and_people section_code, class_code
